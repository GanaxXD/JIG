...
class RewardClaim extends StatefulWidget {
  ...
  RewardClaim(this.pageControler, this.model);
  final PageController pageControler;
  User model;

  @override
  _RewardClaimState createState() => _RewardClaimState(pageControler, model);
}
...
class _RewardClaimState extends State<RewardClaim> {
  ...
  final PageController pageControler;
  User model;
  _RewardClaimState(this.pageControler, this.model);
