...
class CriarQuest extends StatefulWidget {
  ...
  CriarQuest(this.pageController);

  @override
  _CriarQuestState createState() => _CriarQuestState(this.pageController);
}

class _CriarQuestState extends State<CriarQuest> {

  final PageController pageController;
  _CriarQuestState(this.pageController);
