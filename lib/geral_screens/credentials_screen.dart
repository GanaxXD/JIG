  ...
  Widget build(BuildContext context) {
    ...
    body: ScopedModelDescendant<User>(
      builder: (context, child, model) {
        if (model.isLoading)
          return Center(child: CircularProgressIndicator(semanticsLabel: "Buscando registros do guerreiro junto ao oráculo...",
            backgroundColor: Colors.indigoAccent),);
...
//                              builder: (context) => HomeUser()));
  ...
  void _onFail(){
    _scaffoldkey.currentState.showSnackBar(SnackBar(
      ...
      content: Text("Falha ao entrar. Tente novamente e verifique se"
          " seus dados informados estão corretos ou se não existe um espaço em"
          "branco ao fim de algum dos campos informados!",style: TextStyle(
